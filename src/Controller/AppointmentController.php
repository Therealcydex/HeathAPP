...
public function editPrescription(Request $request, Prescription $prescription, EntityManagerInterface $entityManager): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        $entityManager->flush();
        return $this->redirectToRoute('app_appointment_prescriptions', ['id' => $prescription->getAppointment()->getId()]);
    }

    return $this->render('appointment/edit_prescription.html.twig', [
        'form' => $form->createView(),
