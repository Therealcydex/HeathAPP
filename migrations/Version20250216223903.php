 ...
 */
final class Version20250216223903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE useradd (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user DROP identity_card, DROP diploma, CHANGE is_approved is_verified TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE useradd');
        $this->addSql('ALTER TABLE user ADD identity_card VARCHAR(255) DEFAULT NULL, ADD diploma VARCHAR(255) DEFAULT NULL, CHANGE is_verified is_approved TINYINT(1) NOT NULL');
    }
}
